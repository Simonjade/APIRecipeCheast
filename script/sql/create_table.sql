...
CREATE TABLE web."quantity" (
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "number" integer NOT NULL  
);

CREATE TABLE web."ingredient" (
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "name" text NOT NULL,  
...
CREATE TABLE web."user_has_group" (
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "user_id" integer NOT NULL REFERENCES "user"("id"),
...
CREATE TABLE web."group_has_recipe" (
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "group_id" integer NOT NULL REFERENCES "group"("id"),
...
CREATE TABLE web."user_has_role" (
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "user_id" integer NOT NULL REFERENCES "user"("id"),
...
CREATE TABLE web."role_has_permission" (
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "role_id" integer NOT NULL REFERENCES "role"("id"),
...
CREATE TABLE web."recipe_has_ingredient" (
  "id" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "recipe_id" integer NOT NULL REFERENCES "recipe"("id") ON DELETE CASCADE,
